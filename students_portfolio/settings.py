"""
Django settings for students_portfolio project.
...
ROOT_URLCONF = 'students_portfolio.urls'
...
WSGI_APPLICATION = 'students_portfolio.wsgi.application'
...
STATIC_URL = '/static/'
# STATIC_ROOT = '/static/' # deploy uchun
# STATICFILES_DIRS = [
